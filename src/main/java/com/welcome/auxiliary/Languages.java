...
public class Languages {
  public static String getNameFromCode(RepositoryConnection connection, String iso3code) {
    String queryString;
  ...
  public static String getCodeFromName(RepositoryConnection connection, String languageName) {
    String queryString;
